<!-- filepath: resources/views/student-grades.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="grades-container">
        ...
        <div class="term-selector">
            <form method="GET" action="<?php echo e(route('student.grades')); ?>">
