...
<body>
    <div class="container">
        <div class="header-actions">
            ...
            <a href="<?php echo e(route('admin.students.create')); ?>" class="btn btn-add">Add New Student</a>
        </div>
        ...
        <table class="students-table">
            <thead>
                <tr>
                    <th>
                        <a href="<?php echo e(route('admin.students.index', ['sort' => 'student_id', 'direction' => $sortField === 'student_id' && $sortDirection === 'asc' ? 'desc' : 'asc'])); ?>" class="sort-header <?php echo e($sortField === 'student_id' ? 'current-sort' : ''); ?>">
                            Student ID
                    ...
                    <th>
                        <a href="<?php echo e(route('admin.students.index', ['sort' => 'name', 'direction' => $sortField === 'name' && $sortDirection === 'asc' ? 'desc' : 'asc'])); ?>" class="sort-header <?php echo e($sortField === 'name' ? 'current-sort' : ''); ?>">
                            Name
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('students.grades', $student->id)); ?>" class="btn btn-view">View Grades</a>
                            <a href="<?php echo e(route('admin.students.edit', $student->id)); ?>" class="btn btn-edit">Edit</a>
...
</html> <?php /**PATH C:\Users\Jayson Bornas\OneDrive\Desktop\xampp\htdocs\newSIS_laravel\resources\views/admin/students/index.blade.php ENDPATH**/ ?>